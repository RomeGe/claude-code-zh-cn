# macOS native latest candidate failure: 2.1.222
...
- Added upstream strings: 31611
- Removed upstream strings: 16547
- Already covered by translations: 112
- Needs translation review: 31499
- Sensitive review hints: 552
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.222 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.222 --native-macos-arm64
