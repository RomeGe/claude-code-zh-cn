# Windows native latest candidate failure: 2.1.260

- Run: https://github.com/RomeGe/claude-code-zh-cn/actions/runs/33851547093
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.260 --skip-latest --native-windows-x64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.260 --native-windows-x64
