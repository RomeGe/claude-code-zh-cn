# Windows native latest candidate failure: 2.1.251

- Run: https://github.com/RomeGe/claude-code-zh-cn/actions/runs/33379777515
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.251 --skip-latest --native-windows-x64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.251 --native-windows-x64
