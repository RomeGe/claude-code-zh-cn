# macOS native latest candidate failure: 2.1.214
...
- Added upstream strings: 27994
- Removed upstream strings: 14390
- Already covered by translations: 164
- Needs translation review: 27830
- Sensitive review hints: 368
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.214 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.214 --native-macos-arm64
