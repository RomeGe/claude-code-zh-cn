# Windows native latest candidate failure: 2.1.246

- Run: https://github.com/RomeGe/claude-code-zh-cn/actions/runs/32928906651
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.246 --skip-latest --native-windows-x64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.246 --native-windows-x64
