# Windows native latest candidate failure: 2.1.202

- Run: https://github.com/RomeGe/claude-code-zh-cn/actions/runs/28847680846
...
```markdown
# Upstream text diff: 2.1.190 -> 2.1.202

- Added upstream strings: 20975
- Removed upstream strings: 14928
- Already covered by translations: 138
- Needs translation review: 20837
- Sensitive review hints: 242
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.202 --skip-latest --native-windows-x64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.202 --native-windows-x64
