# macOS native latest candidate failure: 2.1.202
...
- Added upstream strings: 21276
- Removed upstream strings: 15688
- Already covered by translations: 91
- Needs translation review: 21185
- Sensitive review hints: 230
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.202 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.202 --native-macos-arm64
