# macOS native latest candidate failure: 2.1.210
...
- Added upstream strings: 24264
- Removed upstream strings: 13891
- Already covered by translations: 225
- Needs translation review: 24039
- Sensitive review hints: 376
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.210 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.210 --native-macos-arm64
