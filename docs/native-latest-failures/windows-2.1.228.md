# Windows native latest candidate failure: 2.1.228

- Run: https://github.com/RomeGe/claude-code-zh-cn/actions/runs/31565522830
...
```markdown
# Upstream text diff: 2.1.190 -> 2.1.228

- Added upstream strings: 36608
- Removed upstream strings: 16383
- Already covered by translations: 244
- Needs translation review: 36364
- Sensitive review hints: 748
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.228 --skip-latest --native-windows-x64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.228 --native-windows-x64
