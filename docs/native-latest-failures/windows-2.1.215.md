# Windows native latest candidate failure: 2.1.215
...
- Added upstream strings: 28675
- Removed upstream strings: 15563
- Already covered by translations: 178
- Needs translation review: 28497
- Sensitive review hints: 426
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.215 --skip-latest --native-windows-x64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.215 --native-windows-x64
