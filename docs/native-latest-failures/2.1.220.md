# macOS native latest candidate failure: 2.1.220
...
- Added upstream strings: 28187
- Removed upstream strings: 14380
- Already covered by translations: 149
- Needs translation review: 28038
- Sensitive review hints: 402
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.220 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.220 --native-macos-arm64
