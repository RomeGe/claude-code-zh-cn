# Windows native latest candidate failure: 2.1.205

- Run: https://github.com/RomeGe/claude-code-zh-cn/actions/runs/29000035651
...
```markdown
# Upstream text diff: 2.1.190 -> 2.1.205

- Added upstream strings: 22212
- Removed upstream strings: 15782
- Already covered by translations: 144
- Needs translation review: 22068
- Sensitive review hints: 291
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.205 --skip-latest --native-windows-x64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.205 --native-windows-x64
