# Windows native latest candidate failure: 2.1.224

- Run: https://github.com/RomeGe/claude-code-zh-cn/actions/runs/31149446426
...
```markdown
# Upstream text diff: 2.1.190 -> 2.1.224

- Added upstream strings: 32067
- Removed upstream strings: 17812
- Already covered by translations: 235
- Needs translation review: 31832
- Sensitive review hints: 521
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.224 --skip-latest --native-windows-x64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.224 --native-windows-x64
