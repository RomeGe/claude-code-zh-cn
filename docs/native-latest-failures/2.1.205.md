# macOS native latest candidate failure: 2.1.205
...
- Added upstream strings: 22844
- Removed upstream strings: 16909
- Already covered by translations: 96
- Needs translation review: 22748
- Sensitive review hints: 276
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.205 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.205 --native-macos-arm64
