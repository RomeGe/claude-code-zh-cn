# macOS native latest candidate failure: 2.1.223
...
- Added upstream strings: 32032
- Removed upstream strings: 16808
- Already covered by translations: 175
- Needs translation review: 31857
- Sensitive review hints: 598
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.223 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.223 --native-macos-arm64
