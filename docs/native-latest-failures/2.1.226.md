# macOS native latest candidate failure: 2.1.226
...
- Added upstream strings: 32461
- Removed upstream strings: 18100
- Already covered by translations: 219
- Needs translation review: 32242
- Sensitive review hints: 471
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.226 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.226 --native-macos-arm64
