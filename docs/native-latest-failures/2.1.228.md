# macOS native latest candidate failure: 2.1.228
...
- Added upstream strings: 36637
- Removed upstream strings: 15153
- Already covered by translations: 219
- Needs translation review: 36418
- Sensitive review hints: 696
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.228 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.228 --native-macos-arm64
