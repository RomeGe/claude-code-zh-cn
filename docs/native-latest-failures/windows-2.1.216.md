# Windows native latest candidate failure: 2.1.216
...
- Added upstream strings: 29522
- Removed upstream strings: 15885
- Already covered by translations: 185
- Needs translation review: 29337
- Sensitive review hints: 434
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.216 --skip-latest --native-windows-x64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.216 --native-windows-x64
