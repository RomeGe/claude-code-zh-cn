# Windows native latest candidate failure: 2.1.212
...
- Added upstream strings: 18330
- Removed upstream strings: 15804
- Already covered by translations: 175
- Needs translation review: 18155
- Sensitive review hints: 365
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.212 --skip-latest --native-windows-x64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.212 --native-windows-x64
