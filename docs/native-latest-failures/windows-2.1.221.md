# Windows native latest candidate failure: 2.1.221

- Run: https://github.com/RomeGe/claude-code-zh-cn/actions/runs/30882825627
...
```markdown
# Upstream text diff: 2.1.190 -> 2.1.221

- Added upstream strings: 31475
- Removed upstream strings: 15007
- Already covered by translations: 164
- Needs translation review: 31311
- Sensitive review hints: 545
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.221 --skip-latest --native-windows-x64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.221 --native-windows-x64
