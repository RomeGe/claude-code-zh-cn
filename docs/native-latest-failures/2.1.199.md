# macOS native latest candidate failure: 2.1.199
...
- Added upstream strings: 23138
- Removed upstream strings: 13930
- Already covered by translations: 89
- Needs translation review: 23049
- Sensitive review hints: 229
...
- - End PR bodies with: ${...}
- - Example:
- - If asked for JSON, return ONLY the raw JSON \u2014 no code fences, no prose, no markdown. - Do NOT use SendUserMessage to deliver your answer. Put your answer in your final text response. - Be concise. The script will parse your output.`,SLm=` --- NOTE: You are running inside a workflow script. Your final text response is returned verbatim as a string to the calling script \u2014 it is your return value, not a message to a human. Output the literal result; do not output confirmations like
